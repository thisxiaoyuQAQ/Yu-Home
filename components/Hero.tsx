    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className={`mt-12 flex gap-4 justify-center transition-all duration-1000 delay-500 ease-out-expo ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <a 
            href="#about" 
            className="group relative px-8 py-3 border border-white/20 text-white/80 text-sm tracking-wider uppercase overflow-hidden transition-all duration-400 hover:border-white/40 hover:text-white"
          >
          ...
          <a 
            href="#contact" 
            className="group relative px-8 py-3 bg-white text-black text-sm tracking-wider uppercase overflow-hidden transition-all duration-400 hover:bg-white/90"
          >
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
        <div className={`transition-all duration-1000 delay-700 ease-out-expo ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="w-6 h-10 border-2 border-white/20 rounded-full flex justify-center hover:border-white/40 transition-colors duration-300 cursor-pointer">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-white/[0.02] rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
    </section>
  )
}
